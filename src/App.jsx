...
export default function App() {
  ...
  const handleSaveToGitHub = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://api.github.com/repos/${REPO_OWNER}/${REPO_NAME}/contents/${FILE_PATH}`, {
        ...
        body: JSON.stringify({
          message: `Update projects and subtasks directly via Dashboard`,
  ...
  // State mutation helpers (marks unsaved changes automatically)
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 pt-6 space-y-6">
              ...
              {summaryProjectsByPriority.map((project) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Checkbox Subtasks in Summary View */}
        ...
        {activeTab === 'dashboard' && (
          <div className="space-y-6">
            ...
            {/* Dashboard Project Cards with Direct Editing */}
